...
@RestController
@RequestMapping("/api/wear-me-kafka")
public class WearMeKafkaResource {
    private final Logger log = LoggerFactory.getLogger(WearMeKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public WearMeKafkaResource(KafkaProperties kafkaProperties) {
